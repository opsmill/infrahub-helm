...
| oci://registry.opsmill.io/opsmill/chart | infrahub-backup | 1.3.0 |
...
| prefect-server.global.prefect.image.prefectTag | string | `"1.10.6"` |  |
...
| upgrade.extraArgs | list | `[]` | Additional arguments passed to the `infrahub upgrade` command, e.g. ["--rebase-branches"] to rebase open branches after migrations that require it |
